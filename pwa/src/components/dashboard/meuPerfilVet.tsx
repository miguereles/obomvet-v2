...
  // FETCH REAL: Carrega os dados do veterinário logado
  useEffect(() => {
    const user = getUser();
...
            <div className="relative w-40 h-40 rounded-full overflow-hidden shadow-md border-4 border-[#004E64]">
              <img
...
            <input type="text" name="nome_completo" value={data.nome_completo || ''} onChange={handleChange} required className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#25A18E]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">CRMV</label>
            <input type="text" name="crmv" value={data.crmv || ''} onChange={handleChange} required className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#25A18E]" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Especialidade</label>
            <div className="relative">
              <Stethoscope size={16} className="absolute left-3 top-3 text-gray-400" />
              <input type="text" name="especialidade" value={data.especialidade || ''} onChange={handleChange} className="w-full pl-9 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#25A18E]" />
            </div>
          </div>
          <div>
...
              <input type="text" name="endereco" value={data.endereco || ''} onChange={handleChange} className="w-full pl-9 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#25A18E]" />
            </div>
          </div>
        </div>
